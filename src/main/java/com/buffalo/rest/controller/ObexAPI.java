...
@RestController
@RequestMapping("/obex/api") 
public class ObexAPI { 
  
	@Autowired
    private ObexService obexService;
  
    public ObexAPI(ObexService productService) 
    { 
        this.obexService = productService; 
    }
    
    @GetMapping("/obexs")  
    public List<Obex> getAllObex() 
    { 
    	return obexService.listAllObex();
    }
    
    @GetMapping("/obexs/sum")  
