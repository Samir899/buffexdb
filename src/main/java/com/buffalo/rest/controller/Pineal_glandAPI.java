...
@RestController
@RequestMapping("/pineal_gland/api") 
public class Pineal_glandAPI { 
  
	@Autowired
    private Pineal_glandService pineal_glandService;
  
    public Pineal_glandAPI(Pineal_glandService productService) 
    { 
        this.pineal_glandService = productService; 
    }
    
    @GetMapping("/pineal_glands")  
    public List<Pineal_gland> getAllPineal_gland() 
    { 
    	return pineal_glandService.listAllPineal_gland();
    }
    
    @GetMapping("/pineal_glands/sum")  
