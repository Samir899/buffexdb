...
@RestController
@RequestMapping("/hypophysis/api") 
public class HypophysisAPI { 
  
	@Autowired
    private HypophysisService hypophysisService;
  
    public HypophysisAPI(HypophysisService productService) 
    { 
        this.hypophysisService = productService; 
    }
    
    @GetMapping("/hypophysiss")  
    public List<Hypophysis> getAllHypophysis() 
    { 
    	return hypophysisService.listAllHypophysis();
    }
    
    @GetMapping("/hypophysiss/sum")  
