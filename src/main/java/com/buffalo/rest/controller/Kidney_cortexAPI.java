...
import com.buffalo.service.Kidney_cortexService;


@RestController
@RequestMapping("/kidney_cortex/api") 
public class Kidney_cortexAPI { 
  
	@Autowired
    private Kidney_cortexService kidney_cortexService;
  
    public Kidney_cortexAPI(Kidney_cortexService productService) 
    { 
        this.kidney_cortexService = productService; 
    }
    
    @GetMapping("/kidney_cortexs")  
    public List<Kidney_cortex> getAllKidney_cortex() 
    { 
    	return kidney_cortexService.listAllKidney_cortex();
    }

    
    @GetMapping("/kidney_cortexs/sum")  
    public Map<String, Double> getSum() 
    {
    	return kidney_cortexService.getFPKMSum();
    }
    

    @GetMapping("/kidney_cortexs/sorted")  
    public List<Kidney_cortex> getKidney_cortexSorted(@RequestParam("lowerLimit") double lowerLimit, @RequestParam("upperLimit") double upperLimit) 
    { 
    	return kidney_cortexService.getKidney_cortexSorted(lowerLimit, upperLimit);
    }
