...
@RestController
@RequestMapping("/medulla_oblongata/api") 
public class Medulla_oblongataAPI { 
  
	@Autowired
    private Medulla_oblongataService medulla_oblongataService;
  
    public Medulla_oblongataAPI(Medulla_oblongataService productService) 
    { 
        this.medulla_oblongataService = productService; 
    }
    
    @GetMapping("/medulla_oblongatas")  
    public List<Medulla_oblongata> getAllMedulla_oblongata() 
    { 
    	return medulla_oblongataService.listAllMedulla_oblongata();
    }
    
    @GetMapping("/medulla_oblongatas/sum")  
