...
import com.buffalo.repo.Reticulum_ARepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class Reticulum_AService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Reticulum_ARepository reticulum_ARepo;
...
//	}
	...
	public List<Reticulum_A> listAllReticulum_A(){
		return (List<Reticulum_A>) reticulum_ARepo.findAll();
	}
	
	public Map<String, Double> getFPKMSum() {
		return reticulum_ARepo.getSum();
	}
	
	public List<Reticulum_A> getReticulum_ASorted(double lowerLimit, double upperLimit){
		return (List<Reticulum_A>) reticulum_ARepo.getReticulum_ASorted(lowerLimit, upperLimit);
