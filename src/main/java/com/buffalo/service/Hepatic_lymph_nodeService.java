...
import com.buffalo.repo.Hepatic_lymph_nodeRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class Hepatic_lymph_nodeService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Hepatic_lymph_nodeRepository hepatic_lymph_nodeRepo;
...
//	}
	...
	public List<Hepatic_lymph_node> listAllHepatic_lymph_node(){
		return (List<Hepatic_lymph_node>) hepatic_lymph_nodeRepo.findAll();
	}
