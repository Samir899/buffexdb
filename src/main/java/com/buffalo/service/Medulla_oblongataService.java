...
@Service
@Transactional
public class Medulla_oblongataService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Medulla_oblongataRepository medulla_oblongataRepo;
...
//	}
	...
	public List<Medulla_oblongata> listAllMedulla_oblongata(){
		return (List<Medulla_oblongata>) medulla_oblongataRepo.findAll();
	}
