...
import com.buffalo.repo.ThymusRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class ThymusService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private ThymusRepository thymusRepo;
...
//	}
	...
	public List<Thymus> listAllThymus(){
		return (List<Thymus>) thymusRepo.findAll();
	}
	
	public Map<String, Double> getFPKMSum() {
		return thymusRepo.getSum();
	}
	public List<Thymus> getThymusSorted(double lowerLimit, double upperLimit){
		return (List<Thymus>) thymusRepo.getThymusSorted(lowerLimit, upperLimit);
