...
import com.buffalo.repo.RumenRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class RumenService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private RumenRepository rumenRepo;
...
//	}
	...
	public List<Rumen> listAllRumen(){
		return (List<Rumen>) rumenRepo.findAll();
	}
	
	public Map<String, Double> getFPKMSum() {
		return rumenRepo.getSum();
	}
	
	public List<Rumen> getRumenSorted(double lowerLimit, double upperLimit){
		return (List<Rumen>) rumenRepo.getRumenSorted(lowerLimit, upperLimit);
