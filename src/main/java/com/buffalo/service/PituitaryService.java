...
import com.buffalo.repo.PituitaryRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class PituitaryService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private PituitaryRepository pituitaryRepo;
...
//	}
	...
	public List<Pituitary> listAllPituitary(){
		return (List<Pituitary>) pituitaryRepo.findAll();
	}
