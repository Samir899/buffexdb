...
import com.buffalo.repo.UterusRepository;
...
public class UterusService {
	...
	@Autowired
	private UterusRepository uterusRepo;
...
//	}
	...
	public List<Uterus> listAllUterus(){
		return (List<Uterus>) uterusRepo.findAll();
	}
	
	public Map<String, Double> getFPKMSum() {
		return uterusRepo.getSum();
	}
	
	public List<Uterus> getUterusSorted(double lowerLimit, double upperLimit){
		return (List<Uterus>) uterusRepo.getUterusSorted(lowerLimit, upperLimit);
