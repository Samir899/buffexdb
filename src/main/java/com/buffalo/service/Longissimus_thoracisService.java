...
import com.buffalo.repo.Longissimus_thoracisRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class Longissimus_thoracisService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Longissimus_thoracisRepository longissimus_thoracisRepo;
