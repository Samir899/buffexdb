...
@Service
@Transactional
public class White_blood_cellService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private White_blood_cellRepository white_blood_cellRepo;
...
//	}
	...
	public List<White_blood_cell> listAllWhite_blood_cell(){
		return (List<White_blood_cell>) white_blood_cellRepo.findAll();
	}
