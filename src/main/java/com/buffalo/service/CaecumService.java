...
import com.buffalo.repo.CaecumRepository;
...
@Service
@Transactional
public class CaecumService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private CaecumRepository caecumRepo;
...
//	}
	...
	public List<Caecum> listAllCaecum(){
		return (List<Caecum>) caecumRepo.findAll();
	}
