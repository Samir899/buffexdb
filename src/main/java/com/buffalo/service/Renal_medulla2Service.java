...
import com.buffalo.repo.Renal_medulla2Repository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class Renal_medulla2Service {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Renal_medulla2Repository renal_medulla2Repo;
...
//	}
	...
	public List<Renal_medulla2> listAllRenal_medulla2(){
		return (List<Renal_medulla2>) renal_medulla2Repo.findAll();
	}
