...
@Service
@Transactional
public class HypophysisService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private HypophysisRepository hypophysisRepo;
...
//	}
	...
	public List<Hypophysis> listAllHypophysis(){
		return (List<Hypophysis>) hypophysisRepo.findAll();
	}
