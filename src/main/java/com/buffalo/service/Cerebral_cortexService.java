...
import com.buffalo.repo.Cerebral_cortexRepository;
...
@Service
@Transactional
public class Cerebral_cortexService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Cerebral_cortexRepository cerebral_cortexRepo;
...
//	}
	...
	public List<Cerebral_cortex> listAllCerebral_cortex(){
		return (List<Cerebral_cortex>) cerebral_cortexRepo.findAll();
	}
