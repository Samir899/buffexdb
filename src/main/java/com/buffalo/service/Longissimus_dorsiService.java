...
import com.buffalo.repo.Longissimus_dorsiRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class Longissimus_dorsiService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Longissimus_dorsiRepository longissimus_dorsiRepo;
...
//	}
	...
	public List<Longissimus_dorsi> listAllLongissimus_dorsi(){
		return (List<Longissimus_dorsi>) longissimus_dorsiRepo.findAll();
	}
	
	public Map<String, Double> getFPKMSum() {
		return longissimus_dorsiRepo.getSum();
	}
	
	public List<Longissimus_dorsi> getLongissimus_dorsiSorted(double lowerLimit, double upperLimit){
		return (List<Longissimus_dorsi>) longissimus_dorsiRepo.getLongissimus_dorsiSorted(lowerLimit, upperLimit);
