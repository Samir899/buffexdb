...
import com.buffalo.repo.Reticulum_BRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class Reticulum_BService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Reticulum_BRepository reticulum_BRepo;
...
//	}
	...
	public List<Reticulum_B> listAllReticulum_B(){
		return (List<Reticulum_B>) reticulum_BRepo.findAll();
	}
