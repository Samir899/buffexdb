...
import com.buffalo.repo.ThyroidRepository;
...
public class ThyroidService {
	...
	@Autowired
	private ThyroidRepository thyroidRepo;
...
//	}
	...
	public List<Thyroid> listAllThyroid(){
		return (List<Thyroid>) thyroidRepo.findAll();
	}
	
	public Map<String, Double> getFPKMSum() {
		return thyroidRepo.getSum();
	}
	public List<Thyroid> getThyroidSorted(double lowerLimit, double upperLimit){
		return (List<Thyroid>) thyroidRepo.getThyroidSorted(lowerLimit, upperLimit);
