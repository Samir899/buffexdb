...
import com.buffalo.repo.Female_gonadRepository;
...
@Service
@Transactional
public class Female_gonadService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Female_gonadRepository female_gonadRepo;
...
//	}
	...
	public List<Female_gonad> listAllFemale_gonad(){
		return (List<Female_gonad>) female_gonadRepo.findAll();
	}
