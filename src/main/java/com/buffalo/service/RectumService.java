...
import com.buffalo.repo.RectumRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class RectumService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private RectumRepository rectumRepo;
...
//	}
	...
	public List<Rectum> listAllRectum(){
		return (List<Rectum>) rectumRepo.findAll();
	}
	
	public Map<String, Double> getFPKMSum() {
		return rectumRepo.getSum();
	}
	public List<Rectum> getRectumSorted(double lowerLimit, double upperLimit){
		return (List<Rectum>) rectumRepo.getRectumSorted(lowerLimit, upperLimit);
