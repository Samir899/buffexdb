...
import com.buffalo.repo.TestisRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class TestisService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private TestisRepository testisRepo;
...
//	}
	...
	public List<Testis> listAllTestis(){
		return (List<Testis>) testisRepo.findAll();
	}
	
	public Map<String, Double> getFPKMSum() {
		return testisRepo.getSum();
	}
	public List<Testis> getTestisSorted(double lowerLimit, double upperLimit){
		return (List<Testis>) testisRepo.getTestisSorted(lowerLimit, upperLimit);
