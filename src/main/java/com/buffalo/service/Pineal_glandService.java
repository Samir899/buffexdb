...
@Service
@Transactional
public class Pineal_glandService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Pineal_glandRepository pineal_glandRepo;
...
//	}
	...
	public List<Pineal_gland> listAllPineal_gland(){
		return (List<Pineal_gland>) pineal_glandRepo.findAll();
	}
