...
import com.buffalo.repo.Kidney_cortexRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class Kidney_cortexService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Kidney_cortexRepository kidney_cortexRepo;
...
//	}
	...
	public List<Kidney_cortex> listAllKidney_cortex(){
		return (List<Kidney_cortex>) kidney_cortexRepo.findAll();
	}

	
	public Map<String, Double> getFPKMSum() {
		return kidney_cortexRepo.getSum();
	}
	public List<Kidney_cortex> getKidney_cortexSorted(double lowerLimit, double upperLimit){
		return (List<Kidney_cortex>) kidney_cortexRepo.getKidney_cortexSorted(lowerLimit, upperLimit);
