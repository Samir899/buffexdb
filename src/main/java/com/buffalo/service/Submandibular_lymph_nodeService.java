...
import com.buffalo.repo.Submandibular_lymph_nodeRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class Submandibular_lymph_nodeService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Submandibular_lymph_nodeRepository submandibular_lymph_nodeRepo;
