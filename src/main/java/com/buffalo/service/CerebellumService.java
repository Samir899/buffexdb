...
import com.buffalo.repo.CerebellumRepository;
...
@Service
@Transactional
public class CerebellumService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private CerebellumRepository cerebellumRepo;
...
//	}
	...
	public List<Cerebellum> listAllCerebellum(){
		return (List<Cerebellum>) cerebellumRepo.findAll();
	}
