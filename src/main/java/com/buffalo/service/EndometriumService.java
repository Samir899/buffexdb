...
@Service
@Transactional
public class EndometriumService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private EndometriumRepository endometriumRepo;
...
//	}
	...
	public List<Endometrium> listAllEndometrium(){
		return (List<Endometrium>) endometriumRepo.findAll();
	}
