...
import com.buffalo.repo.BloodRepository;
...
import com.buffalo.repo.Intestinal_lymph_nodeRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class Intestinal_lymph_nodeService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Intestinal_lymph_nodeRepository intestinal_lymph_nodeRepo;
...
//	}
	...
	public List<Intestinal_lymph_node> listAllIntestinal_lymph_node(){
		return (List<Intestinal_lymph_node>) intestinal_lymph_nodeRepo.findAll();
	}

	
	public Map<String, Double> getFPKMSum() {
		return intestinal_lymph_nodeRepo.getSum();
	}
	public List<Intestinal_lymph_node> getIntestinal_lymph_nodeSorted(double lowerLimit, double upperLimit){
		return (List<Intestinal_lymph_node>) intestinal_lymph_nodeRepo.getIntestinal_lymph_nodeSorted(lowerLimit, upperLimit);
