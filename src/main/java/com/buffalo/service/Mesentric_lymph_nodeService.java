...
@Service
@Transactional
public class Mesentric_lymph_nodeService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Mesentric_lymph_nodeRepository mesentric_lymph_nodeRepo;
...
//	}
	...
	public List<Mesentric_lymph_node> listAllMesentric_lymph_node(){
		return (List<Mesentric_lymph_node>) mesentric_lymph_nodeRepo.findAll();
	}
