...
@Service
@Transactional
public class Granulosa_cellService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Granulosa_cellRepository granulosa_cellRepo;
...
//	}
	...
	public List<Granulosa_cell> listAllGranulosa_cell(){
		return (List<Granulosa_cell>) granulosa_cellRepo.findAll();
	}
