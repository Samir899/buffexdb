...
@Service
@Transactional
public class Leg_muscleService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Leg_muscleRepository leg_muscleRepo;
...
//	}
	...
	public List<Leg_muscle> listAllLeg_muscle(){
		return (List<Leg_muscle>) leg_muscleRepo.findAll();
	}
