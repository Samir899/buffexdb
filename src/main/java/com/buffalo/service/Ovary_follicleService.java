...
import com.buffalo.repo.Ovary_follicleRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class Ovary_follicleService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Ovary_follicleRepository ovary_follicleRepo;
...
//	}
	...
	public List<Ovary_follicle> listAllOvary_follicle(){
		return (List<Ovary_follicle>) ovary_follicleRepo.findAll();
	}
	
	public Map<String, Double> getFPKMSum() {
		return ovary_follicleRepo.getSum();
	}
	
	public List<Ovary_follicle> getOvary_follicleSorted(double lowerLimit, double upperLimit){
		return (List<Ovary_follicle>) ovary_follicleRepo.getOvary_follicleSorted(lowerLimit, upperLimit);
