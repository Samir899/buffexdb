...
import com.buffalo.repo.Prescapular_lymph_nodeRepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class Prescapular_lymph_nodeService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Prescapular_lymph_nodeRepository prescapular_lymph_nodeRepo;
