...
import com.buffalo.repo.SkinRepository;
...
//	}
	...
	public List<Skin> listAllSkin(){
		return (List<Skin>) skinRepo.findAll();
	}
	
	public Map<String, Double> getFPKMSum() {
		return skinRepo.getSum();
	}
	public List<Skin> getSkinSorted(double lowerLimit, double upperLimit){
		return (List<Skin>) skinRepo.getSkinSorted(lowerLimit, upperLimit);
