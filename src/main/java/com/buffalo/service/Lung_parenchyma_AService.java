...
import com.buffalo.repo.Lung_parenchyma_ARepository;

import jakarta.transaction.Transactional;

@Service
@Transactional
public class Lung_parenchyma_AService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Lung_parenchyma_ARepository lung_parenchyma_ARepo;
...
//	}
	...
	public List<Lung_parenchyma_A> listAllLung_parenchyma_A(){
		return (List<Lung_parenchyma_A>) lung_parenchyma_ARepo.findAll();
	}
	
	public Map<String, Double> getFPKMSum() {
		return lung_parenchyma_ARepo.getSum();
	}
	
	public List<Lung_parenchyma_A> getLung_parenchyma_ASorted(double lowerLimit, double upperLimit){
		return (List<Lung_parenchyma_A>) lung_parenchyma_ARepo.getLung_parenchyma_ASorted(lowerLimit, upperLimit);
