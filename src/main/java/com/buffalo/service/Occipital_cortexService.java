...
@Service
@Transactional
public class Occipital_cortexService {
	
	public final int GENE_PER_PAGE = 10;
	
	@Autowired
	private Occipital_cortexRepository occipital_cortexRepo;
...
//	}
	...
	public List<Occipital_cortex> listAllOccipital_cortex(){
		return (List<Occipital_cortex>) occipital_cortexRepo.findAll();
	}
