...
public class Spleen {
	...
	public Spleen(int id, Genes gene, double eRR2352987, double eRR2352988, double eRR2352989, double eRR2352990,
	...
	public String toString() {
		return "Spleen [id=" + id + ", gene=" + gene + ", ERR2352987=" + ERR2352987 + ", ERR2352988=" + ERR2352988
