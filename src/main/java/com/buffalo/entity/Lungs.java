...
public class Lungs {
	...
	public Lungs(int id, Genes gene, double eRR315645, double sRR15721739, double sRR24057925, double sRR24057926,
	...
	public String toString() {
		return "Lungs [id=" + id + ", gene=" + gene + ", ERR315645=" + ERR315645 + ", SRR15721739=" + SRR15721739
